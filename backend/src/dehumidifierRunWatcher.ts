      ...
      try {
        if (change.fullDocument) {
          ...
          const graphqlDehumidifierRun = {
            ...
            startHumidityReading: dehumidifierRun.startHumidityReading,
            endHumidityReading: dehumidifierRun.endHumidityReading,
            humidityUnit: dehumidifierRun.humidityUnit,
            startTemperatureReading: dehumidifierRun.startTemperatureReading,
            endTemperatureReading: dehumidifierRun.endTemperatureReading,
            temperatureUnit: dehumidifierRun.temperatureUnit,
